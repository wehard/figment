...
LayoutTransitionInfo getLayoutTransitionInfo2(const VkImageLayout oldLayout,
...
inline void transitionImageLayout2(const VkCommandBuffer& commandBuffer, const VkImage& image,
                                   const VkImageLayout oldLayout, const VkImageLayout newLayout,
                                   const uint32_t baseMipLevel = 0, const uint32_t mipLevels = 1)
{
    const LayoutTransitionInfo transitionInfo = getLayoutTransitionInfo2(oldLayout, newLayout);
