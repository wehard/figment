...
namespace Figment
{
    ...
    WebGPURenderPipeline &WebGPURenderPipeline::SetDepthStencilState(WGPUTextureFormat format,
    ...
    WebGPURenderPipeline &WebGPURenderPipeline::SetBinding(WGPUBindGroupLayoutEntry bindGroupLayoutEntry,
    ...
    WebGPURenderPipeline &WebGPURenderPipeline::SetColorTargetStates(
