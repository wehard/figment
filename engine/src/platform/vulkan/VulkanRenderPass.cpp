...
namespace Figment
{
    VulkanRenderPass::VulkanRenderPass(const VulkanContext &context,
            const VulkanRenderPass::RenderPassDescriptor &&descriptor) : m_Context(context)
    {
        ...
        VkAttachmentDescription attachment = {
                .format = descriptor.ColorAttachment.Format,
                ...
                .stencilStoreOp = descriptor.ColorAttachment.StencilStoreOp,
        ...
        CheckVkResult(vkCreateRenderPass(m_Context.GetDevice(), &renderPassCreateInfo, nullptr, &m_RenderPass));
    }
